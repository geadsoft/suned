...
function new_link() {
	...
	var delLink =
		...
		'<td class="text-start">' +
		'<div class="mb-2">' +
		'<select class="form-select" class="form-control bg-light border-0" id="productName-1" placeholder="Product Name" required>'+
                ...
                '<li class="list-inline-item edit text-end" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">'+
                '<a href="">'+
