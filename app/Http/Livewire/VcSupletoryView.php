...
class VcSupletoryView extends Component
{   

    public $asignatura, $curso,  $termino="3T", $bloque="1P", $tipo="ES", $nombre, $fecha, $archivo='SI', $puntaje=10, $enlace="", $descripcion="", $estado="A";
    ...
    {
        $this->loadPersonas();
        return view('livewire.vc-supletory-view');
    }
