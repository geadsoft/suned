...
class VcPartialBulletin extends Component
{   
    ...
    public function render()
    {
       ...
       $this->tblparalelo = TmHorarios::query()
        ...
        return view('livewire.vc-partial-bulletin');
    }
    ...
    {   
        ...
        if ($this->calificacion=="L"){
            ...
            $pdf = PDF::loadView('pdf/reporte_boletin_parcial_notasletra',[
            ...
            $pdf = PDF::loadView('pdf/reporte_boletin_parcial_notas',[
                'tblrecords' => $this->tblrecords,
                'asignaturas' => $asignaturas,
                'tblpersons' => $this->tblpersonas,
                'datos' => $datos,
    ...
    public function imprimir($id){
        ...
        $this->dispatchBrowserEvent('abrir-pdf', ['url' => "/preview-pdf/partial-bulletin/{$this->datos}"]);         
    }
