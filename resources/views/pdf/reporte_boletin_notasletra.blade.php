                ...
                <tbody>  
                    ...
                    <tr id="{{$record->id}}-{{$col->id}}">
                        ...
                        @if (isset($tblrecords[$record->id][$col->id]['AI-prom']))
                            <td class="text-center" style="border: 1px solid #ccc; padding: 2px 5px; line-height: 1.2;">{{$tblrecords[$record->id][$col->id]['AI-prom']}}</td>
                        @else
                            <td class="text-center" style="border: 1px solid #ccc; padding: 2px 5px; line-height: 1.2;"></td>
                        @endif
                        @if (isset($tblrecords[$record->id][$col->id]['AG-prom']))
                            <td class="text-center" style="border: 1px solid #ccc; padding: 2px 5px; line-height: 1.2;">{{$tblrecords[$record->id][$col->id]['AG-prom']}}</td>
                        @else
                            <td class="text-center" style="border: 1px solid #ccc; padding: 2px 5px; line-height: 1.2;"></td>
                        @endif
                        <td class="text-center" style="border: 1px solid #ccc; padding: 2px 5px; line-height: 1.2;"><strong>{{$tblrecords[$record->id][$col->id]['promedio']}}</strong></td>
                        <td class="text-center" style="border: 1px solid #ccc; padding: 2px 5px; line-height: 1.2;">{{$tblrecords[$record->id][$col->id]['promedio']}}</td>
                        ...
                        <td class="text-center" style="border: 1px solid #ccc; padding: 2px 5px; line-height: 1.2;">{{$tblrecords[$record->id][$col->id]['examen']}}</td>
                        ...
                        <td class="text-center" style="border: 1px solid #ccc; padding: 2px 5px; line-height: 1.2;"><strong>{{$tblrecords[$record->id][$col->id]['cuantitativo']}}</strong></td>
