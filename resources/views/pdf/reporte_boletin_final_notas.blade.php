            ...
            <table cellpadding="0" cellspancing="0" class="table table-sm table-bordered">
                ...
                <tbody>  
                    ...
                    <tr id="{{$record->id}}-conducta">
                        ...
                        <td colspan="4" class="text-center align-middle" style="border: 1px solid #ccc; padding: 2px 5px; line-height: 1.2;"></td>
                        <td class="text-center align-middle" style="border: 1px solid #ccc; padding: 2px 5px; line-height: 1.2;"><strong>{{ $arrconducta[$record->id]['conducta']['1T'] ?? '-' }}</strong></td>
                        <td colspan="4"></td>
                        <td class="text-center align-middle" style="border: 1px solid #ccc; padding: 2px 5px; line-height: 1.2;"><strong>{{ $arrconducta[$record->id]['conducta']['2T'] ?? '-' }}</strong></td>
                        <td colspan="4"></td>
                        <td class="text-center align-middle" style="border: 1px solid #ccc; padding: 2px 5px; line-height: 1.2;"><strong>{{ $arrconducta[$record->id]['conducta']['3T'] ?? '-' }}</strong></td>
                        <td></td>
                        <td></td>
