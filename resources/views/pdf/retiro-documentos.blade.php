...
<head>
    ...
    <title>Retiro de documentos</title>
...
<div class="contenedor">
    ...
    <div class="comentario">
        ...
        <div class="comentario-texto">
            {{ $cabecera->comentario_retiro ?: 'Sin comentarios registrados.' }}
        </div>
    </div>

    {{-- Estado general --}}
    <div class="estado-general">
        @if($cabecera->documentacion_retirada)
            <span class="estado-completo">
                EXPEDIENTE CON DOCUMENTACIÓN COMPLETA
            </span>
        @else
            <span class="estado-pendiente">
                EXPEDIENTE CON DOCUMENTACIÓN PENDIENTE DE RETIRAR
            </span>
        @endif
    </div>
