...
<head>
    ...
    <title>Certificado Aprovechamiento</title>
            ...
            <table cellpadding="0" cellspacing="0" class="" width="100%">
                ...
                <tr style="font-size:12px">
                    <td width="60%" class="text-center">
                        <p><br><br><br><span style="font-size:18px"><strong>CERTIFICADO DE APROVECHAMIENTO</strong></p> 
                    </td>
                </tr>
            </table>
                ...
                <tbody>
                    <tr style="font-size:13px">
                        ...
                        <td width="90%"><span style="horizontal-align: top; padding-top: 10px">
                            ...
                            EL RECTORADO Y SECRETARÍA DE LA UNIDAD EDUCATIVA "AMERICAN SCHOOL" CERTIFICA QUE EL ALUMNO (a): 
