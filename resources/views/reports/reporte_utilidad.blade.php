...
<body>
    ...
    <section style ="margin-top: -110px;">
        ...
        <table cellpadding="0" cellspacing="0" class="table table-sm" style="font-size:10px">
            <tbody class="list">
                ...
                <tr>
                    <td>Utilidad</td>
                    <td class="text-right">${{number_format($utilidad[0]['vtasnetas']-$utilidad[0]['cstventa'],2)}}</td>
                </tr>            
            </tbody>
        </table>
    </section>
    <section>
        <span style="font-size: 12px"><strong>Las 5 categorias mas vendidas</strong></span>
        <table cellpadding="0" cellspancing="0" width="100%"  class="table table-sm" style="font-size:10px">
            <tbody class="list">
                <tr>
                    <td width="33%">
                        <table border="1" cellpadding="0" cellspacing="0" class="table table-sm" style="font-size:10px">
                            <tbody class="list">
                ...
                <tr>
                    <td width="33%">
                        <img src="{{$urlgraph1}}" width="100%">
                    </td>
                    <td width="34%">
                        <img src="{{$urlgraph2}}" width="100%">
                    </td>
                    <td width="33%">
                        <img src="{{$urlgraph3}}" width="100%">
                    </td>
                </tr>
            </tbody>
        </table>
    ...
    <section>
        <span style="font-size: 12px"><strong>Los 5 Productos mas vendidos</strong></span>
        <table cellpadding="0" cellspancing="0" width="100%"  class="table table-sm" style="font-size:10px">
            <tbody class="list">
                <tr>
                    <td width="33%">
                        <table border="1" cellpadding="0" cellspacing="0" class="table table-sm" style="font-size:10px">
                            <tbody class="list">
                            @foreach ($tblgraph4 as $key => $record)    
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td>{{$record['nombre']}}</td>
                                    <td class="text-right">{{number_format($record['valor'],2)}}</td> 
                    ...
                    <td width="34%">
                        <table border="1" cellpadding="0" cellspacing="0" class="table table-sm" style="font-size:10px">
                            <tbody class="list">
                            @foreach ($tblgraph5 as $key => $record)    
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td>{{$record['nombre']}}</td>
                                    <td class="text-right">{{number_format($record['valor'],2)}}</td> 
                    ...
                    <td width="33%">
                        <table border="1" cellpadding="0" cellspacing="0" class="table table-sm" style="font-size:10px">
                            <tbody class="list">
                            @foreach ($tblgraph6 as $key => $record)    
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td>{{$record['nombre']}}</td>
                                    <td class="text-right">{{number_format($record['valor'],2)}}</td> 
                ...
                <tr>
                    <td width="33%">
                        <img src="{{$urlgraph4}}" width="100%">
                    </td>
                    <td width="34%">
                        <img src="{{$urlgraph5}}" width="100%">
                    </td>
                    <td width="33%">
                        <img src="{{$urlgraph6}}" width="100%">
                    </td>
                </tr>
            </tbody>
        </table>
