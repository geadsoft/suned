                ...
                <td width="50%" style="vertical-align: top; padding-top: 10px; position: relative">
                    <table cellpadding="0" cellspacing="0" class="table table-sm align-middle" style="font-size:10px">
                        ...
                        <tbody class="list"> 
                                ...
                                <tr>
                                    <td>Saldo</td>
                                    <td class="text-right">{{number_format($tblrecords->where('tipovalor','DB')->sum('valor')-($tblrecords->where('tipovalor','CR')->sum('haber')+$tblrecords->where('tipovalor','CR')->sum('descuento')),2)}}</td>
                                </tr>
                        </tbody>
                    </table>
                </td>           
