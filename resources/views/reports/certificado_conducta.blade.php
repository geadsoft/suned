...
<head>
    ...
    <title>Certificado Conducta</title>
            ...
            <table cellpadding="0" cellspacing="0" class="" width="100%">
                ...
                <tr style="font-size:12px">
                    <td width="60%" class="text-center">
                        <p><br><br><br><span style="font-size:18px"><strong>CERTIFICADO DE CONDUCTA</strong></p> 
                    </td>
                </tr>
            </table>
                ...
                <tbody>
                    <tr style="font-size:13px">
                        ...
                        <td width="90%"><span style="horizontal-align: top; padding-top: 10px">
                            ...
                            EL SUSCRITO RECTORADO Y SECRETARÍA DEL COLEGIO PARTICULAR "AMERICAN SCHOOL" CERTIFICA QUE EL (LA) SR (SRTA): 
                            <strong>{{$data['nombres']}}</strong>, OBTUVO LA SIGUIENTE CONDUCTA EN EL <strong>{{$data['especializacion']}}: </strong><br><br>
                            <strong>{{$data['escala']}}</strong> ({{$numletra}}) <strong>EN CONDUCTA</strong> &nbsp;  &nbsp; &nbsp; &nbsp;  
                            &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp;
                            EN EL PERIODO LECTIVO <strong>{{$data['periodo']}}</strong><br><br>
