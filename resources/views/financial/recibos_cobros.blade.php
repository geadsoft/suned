    ...
    @foreach ($recibos as $recno)
            ...
            <table cellpadding="0" cellspancing="0" width="100%">
                <tr>
                    <td width="100%" style="vertical-align: top; padding-top: 10px">
                        ...
                        <strong>Recibo de Cobro No. {{$tblrecords[$recno->id]['documento']}}</strong>
                        @if ($tblrecords[$recno->id]->estado=='A')
                ...
                <tr>
                    <td width="70%" class="text-center" style="vertical-align: top; padding-top: 10px">
                        ...
                        <table width="100%" cellpadding="0" cellspancing="0">
                            <tr>
                                <td class="text-left text-muted"><span style="font-size: 12px"><strong>Fecha de Emision: {{date('d/m/Y',strtotime($tblrecords[$recno->id]['fecha']))}} </strong></span></td>
                            </tr>
                            <tr>
                                <td class="text-left text-muted"><span style="font-size: 12px"><strong>Fecha de Pago: {{date('d/m/Y',strtotime($tblrecords[$recno->id]['fechapago']))}} </strong></span></td>
                            </tr>
                            <tr>
                                <td class="text-left text-muted"><span style="font-size: 12px"><strong>Estudiante: {{$tblrecords[$recno->id]->estudiante->apellidos}} {{$tblrecords[$recno->id]->estudiante->nombres}}</strong></span></td>
                            </tr>
                            <tr>
                                <td class="text-left text-muted"><span style="font-size: 12px"><strong>Matricula: {{$tblrecords[$recno->id]->matricula->documento}} - {{$tblrecords[$recno->id]->matricula->modalidad->descripcion}}</strong></span></td>
                            </tr>
                            <tr>
                                <td class="text-left text-muted"><span style="font-size: 12px"><strong>Curso: {{$tblrecords[$recno->id]->matricula->curso->servicio->descripcion}} - {{$tblrecords[$recno->id]->matricula->curso->paralelo}}</strong></span></td>
                            </tr>
                            <tr>
                                <td class="text-left text-muted"><span style="font-size: 12px"><strong>Recaudador: {{$tblrecords[$recno->id]->usuario}} </strong></span></td>
                            </tr> 
                        </table>
                    </td>           
                <tr>
        ...
        <section style ="margin-top: -110px;">
            <table cellpadding="0" cellspacing="0" class="table table-nowrap align-middle" style="font-size:10px">
                ...
                <thead>
                <tbody class="list">
                @foreach ($tbldeudas[$recno->id] as $record)    
                    <tr>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td colspan="4"></td>
                        <td colspan="1">
                            <span><strong>${{number_format($tbldeudas[$recno->id]->sum('saldo'),2)}}<strong></span>
                        </td> 
                    </tr>
                    <tr>
                        <td colspan="2"></td>
                        ...
                        <td colspan="4"></td>
                        <td colspan="1">
                            <span><strong>${{number_format($tbldeudas[$recno->id]->sum('descuento'),2)}}<strong></span>
                        </td> 
                    </tr>
                    <tr>
                        <td colspan="2"></td>
                        ...
                        <td colspan="4"></td>
                        <td colspan="1">
                            <span><strong>${{number_format($tbldeudas[$recno->id]->sum('saldo')-$tbldeudas[$recno->id]->sum('descuento'),2)}}<strong></span>
                        </td> 
                    </tr>
                    <tr>
                        <td colspan="2"></td>
                        ...
                        <td colspan="4"></td>
                        <td colspan="1">
                            <span><strong>${{number_format($tbldeudas[$recno->id]->sum('valor'),2)}}<strong></span>
                        </td> 
                    </tr>
                    <tr>
                        <td colspan="2"></td>
                        ...
                        <td colspan="4"></td>
                        <td colspan="1">
                            <span><strong>${{number_format($tbldeudas[$recno->id]->sum('saldo')-$tbldeudas[$recno->id]->sum('descuento')-$tbldeudas[$recno->id]->sum('valor'),2)}}<strong></span>
                        </td> 
                    </tr>
                </tfoot>
            </table>
                ...
                <tr>
                    <td width="40%" style="vertical-align: top; padding-top: 10px; position: relative">
                        <table cellpadding="0" cellspacing="0" class="table table-sm align-middle" style="font-size:10px">
                            ...
                            <thead>
                            <tbody class="list"> 
                                @foreach ($tblcobros[$recno->id] as $record)    
                                <tr>
