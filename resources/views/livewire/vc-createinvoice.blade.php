            ...
            <div class="card">
                <form autocomplete="off" wire:submit.prevent="{{ 'createData' }}" id="invoice_form">
                    ...
                    <div class="card-body p-4">
                        ...
                        @livewire('vc-detailinvoice',['personaId' => $personaId])
                            ...
                            <div class="col-lg-7">
                                <div class="mb-3 sm-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="mb-3">
                                            <select type="select" class="form-select bg-light border-0" id="periodoInput" wire:model="periodoId">
                                                <option value="">Seleccione Periodo</option>
                                                    @foreach ($tblperiodos as $tblperiodo) 
                                                    <option value="{{$tblperiodo->id}}">{{$tblperiodo->descripcion}}</option>
                                                    @endforeach 
                                            </select>
                                            </div>
                                            <div class="mb-3">
