                            ...
                            <table class="table table-bordered table-sm fs-12" id="orderTable">
                                ...
                                <tr id="{{$fil}}" class="detalle">
                                    ...
                                    <td><div class="d-flex align-items-center">
                                        @if($selectedId === $record['asignaturaId'])
                                        <a href="#" wire:click="verDetalles({{ $fil }})" class="text-warning d-inline-block me-2">
                                            <i class="ri-indeterminate-circle-fill fs-16"></i>
                                        </a>
                                        @else
                                        <a href="#" wire:click="verDetalles({{ $fil }})" class="text-primary d-inline-block me-2">
                                ...
                                <tr>
                                    ...
                                    @if($detalle->actividad=='AI')
                                    <td class="text-center">{{number_format($detalle->nota,2)}}</td>
                                    @else
                                    <td class="text-center"></td>
                                    @endif
                                    @if($detalle->actividad=='AG')
                                    <td class="text-center">{{number_format($detalle->nota,2)}}</td>
                                    @else
                                    <td class="text-center"></td>
                                    @endif
