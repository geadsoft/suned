                        ...
                        <div class="card-header  border-0">
                            <div class="d-flex align-items-center">
                                <h6 class="card-title mb-0 flex-grow-1 text-primary fw-semibold"><i
                                            class="ri-calendar-check-fill align-middle me-1 text-primary fs-20"></i>Ver Exámen</h5>
                            </div>
                        </div>
                        <div class="card-body border border-dashed border-end-0 border-start-0">  
                            <div class="row align-items-start mb-3">
                                <div class="col-sm-2">
                                    ...
                                    <div class="mb-3">
                                        <label for="termino-input" class="form-label form-control border-0 fw-semibold fs-14">Término</label>
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="col-sm-10">  
                                    ...
                                    <div class="mb-3">
                                      <label class="form-control border-0 fs-14">Exámen {{$arrtermino[$termino]}}</label>
                                    </div>
                                    <div class="mb-3">
