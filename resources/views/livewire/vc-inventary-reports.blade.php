                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-auto ms-auto">
                                <div class="hstack text-nowrap gap-2">
                                    ...
                                    @else
                                    <a href="/preview-pdf/detail-movements/{{$datos}}" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" target="_blank"><i class="ri-printer-fill fs-22 align-bottom fs-22"></i></a>
                                    <a href="/download-pdf/detail-movements/{{$datos}}" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"><i class="ri-download-2-line fs-22 align-bottom fs-22"></i></a>
                                    @endif
