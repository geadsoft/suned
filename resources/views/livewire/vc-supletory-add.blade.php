<div>
    <form id="createactivity-form" autocomplete="off" wire:submit.prevent="{{ 'createData' }}" class="needs-validation" >
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-4">
                                <label for="choices-publish-status-input" class="form-label fw-semibold">Tipo de Exámen</label>
                                <select class="form-select" id="choices-publish-status-input" data-choices data-choices-search-false wire:model.defer="tipo" required {{$control}}>
        ...
        <div class="text-end mb-3">
            ...
            @endif
            <a class="btn btn-secondary w-sm" href="/activities/suppletory"><i class="me-1 align-bottom"></i>Cancelar</a>
        </div>
    </form>
</div>
