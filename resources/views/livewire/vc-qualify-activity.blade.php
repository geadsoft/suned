                            ...
                            <table class="table table-bordered table-sm align-middle mb-0" id="orderTable">
                                ...
                                <tr id="{{$fil}}" class="detalle">
                                    ...
                                    <td>
                                        ...
                                        id="{{$fil}}-{{$col}}" wire:model="tblrecords.{{$record->id}}.{{$tarea['id']}}" />
                                    </td>
                                    @endforeach
                                    <td>
                                        <input type="text" class="form-control bg-white border-0" id="promedio-{{$record->id}}" value="{{$record["promedio"]}}" disabled/>
                                    </td>
                                </tr>
                                 @endforeach
                                </tbody>
