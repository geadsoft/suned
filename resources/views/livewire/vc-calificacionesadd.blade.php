                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-xxl-6 col-sm-6">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-lg-9">
                                            <select class="form-select" id="cmbgrupo" wire:model="grupoId" required> 
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-lg-3">
                                            <label class="form-label mt-2 me-5" for="">Modalidad</label>
                                        </div>
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                            <!-- Base Radios -->
                                            <div class="form-check form-radio-success mb-2 mt-2 me-5">
                                                <input class="form-check-input" value="T" type="radio" name="flexRadioDefault" id="flexRadioDefault1" wire:model="modo" checked>
                                                <label class="form-check-label" for="flexRadioDefault1">
                                                    Trimestre
                                                </label>
                                            </div>
                                            <div class="form-check form-radio-warning mb-2 mt-2 me-5">
                                                <input class="form-check-input" value="Q" type="radio" name="flexRadioDefault" id="flexRadioDefault2" wire:model="modo" >
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-lg-3">
                                            <label class="form-label mt-2 me-5" for="cmbpacademico">Periodo Académico</label>
                                        </div>
                                        <div class="col-lg-9">
                                            <select class="form-select" id="cmbpacademico" wire:model="pacademico" required> 
                    ...
                    <div>
                        <div class="table-responsive table-card mb-1">
                            <table class="table table-nowrap align-middle" id="orderTable">
                                ...
                                @if ($tbldetalle != null)
                                    @foreach ($tbldetalle as $data)
                                    <tr>
                                        <td>{{$data['nui']}}</td>
                                        <td>{{$data['apellidos']}}</td>
                                        <td>{{$data['nombres']}}</td>
                                        <td><input type="date" class="form-control form-control-sm" id="fechaActual" data-provider="flatpickr" data-date-format="d-m-Y" data-time="true" wire:model.defer=""></td>
                                        <td><input type="number" step="0.01" class="form-control form-control-sm product-price"
                                                     id="1" wire:model="" /></td>
                                    </tr>
                                    @endforeach
                                @endif
