            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarPerson">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="/academic/person" class="nav-link" role="button">@lang('translation.students')
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="areas" class="nav-link" role="button">@lang('translation.teachers')
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="areas" class="nav-link" role="button">@lang('translation.representatives')
                                </a>
                            </li>
                        </ul>
                    </div>
